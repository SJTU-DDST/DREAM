...
clis=("192.168.98.70" "192.168.98.71" "192.168.98.72" "192.168.98.73" "192.168.98.74" "192.168.98.75")
if [ "$1" = "out" ]
then
    ...
    do 
        echo "cli" $cli
        rm -f ./out$cli.txt
        sshpass -p '1111' scp congyong@$cli:/home/congyong/out.txt ./out$cli.txt
        cli_num=$3
        coro_num=$4
