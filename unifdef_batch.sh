...
#define TEST_SEG_SIZE 0 // 使用大的main_seg，相当于禁用分裂

# 定义要使用的宏
DEFINES="-DMODIFIED=1 -DTEST_SEND=1 -DSEND_TO_CURSEG=1 -DREMOVE_CAS=1 -DRDMA_SIGNAL=1 -DWRITE_WITH_IMM_SIGNAL=1 -DCORO_DEBUG=1 -DFAA_DETECT_FULL=1 -DNO_BEFORE_READ=1 -DLARGER_FP_FILTER_GRANULARITY=1 -DSEND_MULTI_SEG=1 -DTEST_SEG_SIZE=0"
